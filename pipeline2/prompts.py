...
注意:
1. 适合年级只能是大学的题目, 分析题目适合大学几年级学生做,即大一/大二/大三/大四
...
现在给定问题,请按照上面的格式回答。你的回答只需要包括适合年级和子学科,不要添加其他任何内容。
问题:
"""
...
现在给定问题,请按照上面的格式回答。你的回答只需要包括考察知识点和分析过程,不要添加其他任何内容。
问题:
"""
